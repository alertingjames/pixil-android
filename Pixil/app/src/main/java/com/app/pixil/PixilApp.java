...
public class PixilApp extends Application {
    public static final String TAG = PixilApp.class.getSimpleName();

    private String m_gsmToken = "";

    private static final String LOG_TAG = "CrashCatch";

    private static PixilApp _instance;

    public static PixilApp getApplication() {
        return _instance;
    }
    ...
    public static synchronized PixilApp getInstance(){
