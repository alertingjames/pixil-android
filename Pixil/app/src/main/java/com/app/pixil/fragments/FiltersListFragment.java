...
import com.app.pixil.adapters.ThumbnailsAdapter;
import com.app.pixil.commons.Commons;
import com.app.pixil.main.EditPhotoActivity;
import com.app.pixil.utils.BitmapUtils;
import com.app.pixil.utils.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            public void run() {
                ...
                if (bitmap == null) {
//                    thumbImage = BitmapUtils.getBitmapFromUri(getActivity(), Uri.fromFile(Commons.image.getFile()));
                    thumbImage = BitmapFactory.decodeFile(Commons.image.getFile().getPath());
                } else {
